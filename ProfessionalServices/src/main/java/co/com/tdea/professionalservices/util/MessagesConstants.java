...
public class MessagesConstants {
	...
	public static final String ENTITY_NOT_EXISTS_EMAIL = "Lo sentimos, no encontramos información con tu correo , Por favor completa tu información";

	public static final int DEFAULT_ERROR_CODE = 99;
	public static final String DEFAULT_ERROR_MESSAGE = "Error realizando la operacion";
}
